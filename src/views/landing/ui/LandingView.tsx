...
export default function LandingView() {
  return (
    <div className="flex min-h-full flex-1 flex-col bg-white">
      ...
      {/* 이용 방법 */}
      <div className="mx-auto w-full max-w-[1280px] px-6 pt-14">
      ...
      {/* 결과 화면 미리보기 */}
      <div className="mx-auto w-full max-w-[1280px] px-6 pt-12">
        <div className="mb-6 flex items-baseline gap-2.5">
          <span className="h-5 w-1 bg-ember" />
          <h2 className="text-[22px] font-extrabold tracking-[-0.03em] text-ink">
            이런 결과가 나옵니다
      ...
      <div className="mt-auto">
        <div className="mx-auto mt-10 flex max-w-[1280px] items-center justify-between border-t border-[#dfe3e9] px-6 py-8">
